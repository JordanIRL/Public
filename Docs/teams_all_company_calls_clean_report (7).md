...
1. **Teams Town hall** as the event format.
...
All-company broadcasts should be set up as **Teams Town halls**.

Town hall is the right format for this use case because it is designed for one-to-many delivery and provides production controls for managing what attendees see.
