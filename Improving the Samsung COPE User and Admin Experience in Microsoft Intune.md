...
Source: [Microsoft - Android Enterprise device restrictions](https://learn.microsoft.com/en-us/intune/device-configuration/templates/ref-device-restrictions-android-enterprise)
...
Source: [NIST SP 800-63B](https://pages.nist.gov/800-63-4/sp800-63b.html)
...
Source: [Microsoft - Android Enterprise security configurations](https://learn.microsoft.com/en-us/intune/device-security/security-configurations/android-fully-managed)
...
Source: [Microsoft - Android work profiles and App Protection Policy](https://learn.microsoft.com/en-us/intune/app-management/protection/mam-vs-work-profiles-android)
...
Source: [Microsoft - Actions for noncompliance](https://learn.microsoft.com/en-us/intune/protect/actions-for-noncompliance)
...
Source: [Samsung - Knox Service Plugin policies](https://docs.samsungknox.com/admin/knox-platform-for-enterprise/knox-service-plugin/policies/)
...
Source: [Samsung - Knox Platform for Enterprise licenses](https://docs.samsungknox.com/admin/knox-platform-for-enterprise/before-you-begin/knox-platform-for-enterprise-licenses/)
...
Source: [Microsoft - Android device staging](https://learn.microsoft.com/en-us/intune/device-enrollment/android/device-staging)
...
Source: [Microsoft - Android managed app configuration](https://learn.microsoft.com/en-us/intune/apps/app-configuration-policies-use-android)
...
Source: [Microsoft - Android Enterprise security recommendations](https://learn.microsoft.com/en-us/intune/device-security/security-configurations/android-personally-owned)
...
Source: [Google - Android Enterprise feature list](https://developers.google.com/android/work/requirements)
...
Source: [Microsoft - Deploy Remote Help](https://learn.microsoft.com/en-us/intune/remote-help/deploy)
...
Source: [Microsoft - Android Enterprise Wi-Fi settings](https://learn.microsoft.com/en-us/intune/device-configuration/templates/ref-wifi-settings-android-enterprise)
...
Source: [Microsoft - Samsung Knox E-FOTA integration](https://learn.microsoft.com/en-us/intune/device-updates/android/setup-samsung-knox)
...
Source: [Microsoft - Android settings catalog](https://learn.microsoft.com/en-us/intune/device-configuration/settings-catalog/ref-android-settings)
...
Source: [Microsoft - Android corporate enrollment methods](https://learn.microsoft.com/en-us/intune/device-enrollment/android/ref-corporate-methods)
...
Source: [Google - Android Enterprise overview](https://developers.google.com/android/work/overview)
